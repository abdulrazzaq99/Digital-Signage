...
export interface ActivityFilters { action?: string; resourceType?: string; status?: "SUCCESS" | "PENDING" | "FAILED"; companyId?: string; from?: string; to?: string; search?: string; page?: number; pageSize?: number }
