    ...
    <div className="space-y-5">
      ...
      <div className="grid gap-6 xl:grid-cols-[1fr_460px]">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 gap-2 sm:grid-cols-3">{[["Created", t.created], ["Last Updated", t.updated], ["Used In", `${t.usedIn} playlists`]].map(([k, v]) => <Card key={k} className="px-3 py-2"><div className="text-[10px] text-slate-400">{k}</div><div className="text-xs font-semibold text-slate-900">{v}</div></Card>)}</div>
          <div>
