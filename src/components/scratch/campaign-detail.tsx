  ...
  return (
    <ScratchShell tab="campaigns" compact>
      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="flex flex-wrap gap-2"><Button href={`/scratch-win/${c.id}/edit`} variant="secondary"><Pencil className="h-3.5 w-3.5" /> Edit Campaign</Button>{c.status === "Active" && <Button variant="warning-outline" onClick={() => setDeact(true)}><Power className="h-3.5 w-3.5" /> Deactivate</Button>}</div>
      </div>
